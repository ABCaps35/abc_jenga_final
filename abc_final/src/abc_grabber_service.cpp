...
bool serviceCB(abc_final::ObjectGrabberServiceRequest& request, abc_final::ObjectGrabberServiceResponse& response){
...
int main(int argc, char** argv) {
    ...
    ros::ServiceServer service = nh.advertiseService("grabber_service",serviceCB);
